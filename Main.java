    ...
    public static void main(String[] args) {
        ...
        while(!partieFinie){
            ...
            if (choix_mode == 1 && courant.getId() == 2) {
                ...
                choix_borne_revendique = Affichage.lireEntier(scanner, "Joueur " + courant.getId() + " : Revendiquer ? [1] OUI  [2] NON : ");
            }

            // Revendication
            if(choix_borne_revendique == 2){
                jeu.revendiquer(choix_borne, choix_borne_revendique - 3);
            }else{
