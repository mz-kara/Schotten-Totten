...
public class CarteTactique extends Carte {
    ...
    public boolean isModeDeCombat() {
    return nom.equals(COLIN_MAILLARD) || nom.equals(COMBAT_DE_BOUE);
    }

    public boolean isRuse() {
        return nom.equals(CHASSEUR_DE_TETE) || nom.equals(STRATEGE) || nom.equals(BANSHEE) || nom.equals(TRAITRE);
    }
